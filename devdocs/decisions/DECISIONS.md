...
| [ADR-005](./ADR-005-FHIR-Persistence-Architecture.md)            | FHIR Persistence Architecture for Hospital Platform | Accepted | 2026-02-18 | High - Defines per-resource table design + phased persistence/search strategy |
